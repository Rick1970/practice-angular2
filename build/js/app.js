...
var ToDoList;
(function (ToDoList) {
    ToDoList.describeTaskForPerson = function (assignee, taskCollection) {
        var descriptions = [];
...
console.log(tasks);
var thorTasks = ToDoList.describeTaskForPerson(people.thor, tasks);
console.log("Here are Thors tasks:");
